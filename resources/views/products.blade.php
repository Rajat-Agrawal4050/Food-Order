  ...
  <section class="ftco-section">
    <div class="container">
      ...
      <div class="row">
        ...
        $res = Product::where(function ($query) use ($id) {
        ...
        if (isset($res[0])) {
          ...
          // to make link for access storage folder resources
          // use php artisan storage:link command
          // [D:\vegfood\public\storage] link has been connected to [D:\vegfood\storage\app/public].
        ...
        ?>
          ...
          ?>
          <div> {{ $res->links('vendor.pagination.custom') }} </div>
